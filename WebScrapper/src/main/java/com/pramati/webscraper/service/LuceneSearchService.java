...
public class LuceneSearchService {
	...
	public List<String> searchForData(String queryString) throws ParseException, IOException, JSONException {
		...
		List<String> searchResultJson = new ArrayList<String>();
		
		if (htmlDataList.size() > 0) {
			for (ExtractedDataDetails individualResult : htmlDataList) {
				searchResultJson.add(AMQPJsonUtil.objectToJsonSting(individualResult));
			}
